...
#ifdef RGNANO
#define SHELL_CMD_SET_LAUNCHER_GMENU2X      "frontend set gmenu2x"
#define SHELL_CMD_SET_LAUNCHER_RETROFE      "frontend set retrofe"
#define SHELL_CMD_SET_LAUNCHER_ADVMENU      "frontend set advmenu"
#define SHELL_CMD_SET_LAUNCHER_SIMPLEMENU   "frontend set simplemenu"
#else
#define SHELL_CMD_SET_LAUNCHER_GMENU2X      "set_launcher gmenu2x"
#define SHELL_CMD_SET_LAUNCHER_RETROFE      "set_launcher retrofe"
#define SHELL_CMD_SET_LAUNCHER_ADVMENU      "set_launcher advmenu"
#define SHELL_CMD_SET_LAUNCHER_SIMPLEMENU   "set_launcher simplemenu"
#endif
#endif
